...
class PaperReviewerCanSeeAuthoringCest 
{
    ...
    public function PaperReviewerSeePredefinedSearchesTest(SearchStep $I)
    {
        $I->wantTo('see item reviewers predefined searches, but no other');
        $I->seePaperReviewersPredefinedSearches();
        ...
        $I->cantSeePaperSettersPredefinedSearches();
        $I->cantSeePaperApproversPredefinedSearches();
        $I->cantSeeAssetManagersPredefinedSearches();
        $I->cantSeeAnyItemPredefinedSearches();        
    }

    public function PaperReviewerSeeMyReviewingPapersListTest(ListStep $I)
    {
        $I->wantTo('see my review paper list when I have logged in');
        ...
        $I->seeMyReviewPapersCorrectHeaders();

        $I->expect('url to include filter on my reviewing items'); //Default for item reviewer
        $I->seeCurrentUrlEquals(AuthoringPage::$myReviewingPapersUrl);
    }
