...
class UserCantReplaceItemDuplicateInArchivePaperCest
{
    /**
     * @param LoginStep $I
     * @throws Exception
    ...
    {
        $paperId = ItemPaperData::$allGeneralMaths['archivePaperAllSharedItems']['paperid'];
        $item = ItemPaperData::$allGeneralMaths['archivePaperAllSharedItems']['items'][3];
    ...
    {
        $paperId = ItemPaperData::$allGeneralMaths['archivePaperAllSharedItems']['paperid'];
        $item = ItemPaperData::$allGeneralMaths['archivePaperAllSharedItems']['items'][4];
        $I->openItemInReadOnlyWithPaperId($item['id'], $paperId);
        $I->waitForElementVisible(ItemPage::$previewTab, 5);
        $I->waitThenClick(ItemPage::$editItemButton);
        $I->dontSee(PaperPage::$createDuplicateButtonText);
